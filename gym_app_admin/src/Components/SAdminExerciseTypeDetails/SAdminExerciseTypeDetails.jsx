...
import "./SAdminExerciseTypeDetails.css";

class SAdminExerciseTypeDetails extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    sAdminExerciseTypeApi
      .sAdminGetExerciseTypeDetails(exerciseTypeId, formattedToken)
      .then((response) => {
  ...
  deleteData(exerciseTypeId) {
    ...
    sAdminExerciseTypeApi
      ...
      .then((response) => {
        ...
        history.push(routesList.S_ADMIN_GET_EXERCISE_TYPE_LIST);
      });
  }
      ...
      <>
        <div className="d-flex justify-content-between">
          ...
          <div>
            <Link
              to={{
                pathname: routesList.S_ADMIN_GET_EXERCISE_TYPE_LIST,
                state: { data: "test data" },
              }}
...
const connectedSAdminExerciseTypeDetails = connect(mapStateToProps)(
  SAdminExerciseTypeDetails
);

export { connectedSAdminExerciseTypeDetails as SAdminExerciseTypeDetails };
