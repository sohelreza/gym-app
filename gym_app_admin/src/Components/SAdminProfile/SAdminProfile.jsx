...
import "./SAdminProfile.css";

class SAdminProfile extends Component {
  constructor(props) {
    super(props);
  ...
  showData(profileData) {
    ...
    return (
      <>
        ...
        <Link
          to={{
            pathname: routesList.S_ADMIN_UPDATE_PROFILE,
...
export default connect(mapStateToProps)(SAdminProfile);
