...
class SAdminDietTypeDetailsEdit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handleSubmit(e) {
    ...
    sAdminDietTypeApi
      .sAdminEditDietType(updatedDietTypeData, dietTypeId, formattedToken)
      .then((response) => {
        ...
        history.push(
          routesList.S_ADMIN_GET_DIET_TYPE_DETAILS + "/" + dietTypeId
        );
      })
      .catch((error) => {
        this.setState({
...
const connectedSAdminDietTypeDetailsEdit = connect(mapStateToProps)(
  SAdminDietTypeDetailsEdit
);

export { connectedSAdminDietTypeDetailsEdit as SAdminDietTypeDetailsEdit };
