...
class SAdminExerciseTypeDetailsEdit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
...
const connectedSAdminExerciseTypeDetailsEdit = connect(mapStateToProps)(
  SAdminExerciseTypeDetailsEdit
);

export { connectedSAdminExerciseTypeDetailsEdit as SAdminExerciseTypeDetailsEdit };
