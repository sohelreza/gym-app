...
import "./SAdminUpdateProfile.css";

class SAdminUpdateProfile extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit(e) {
    ...
    sAdminProfileApi
      .sAdminUpdateProfile(fileData, formattedToken)
      .then((response) => {
...
export default connect(mapStateToProps)(SAdminUpdateProfile);
