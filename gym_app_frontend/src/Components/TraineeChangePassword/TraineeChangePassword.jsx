...
class TraineeChangePassword extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    traineeProfileApi.traineeGetProfile(formattedToken).then((response) => {
  ...
  handleSubmit(e) {
    ...
    traineeProfileApi
      .traineeChangePassword(updatedData, formattedToken)
      .then((response) => {
...
export default connect(mapStateToProps)(TraineeChangePassword);
